...
type LayoutRouteId = RouteId | "/(app)" | "/(app)/approvals" | "/(app)/conflicts" | "/(app)/conflicts/[id]" | "/(app)/connections" | "/(app)/connections/[id]" | "/(app)/connections/new" | "/(app)/pairs" | "/(app)/pairs/[id]" | "/(app)/pairs/new" | "/(app)/repositories" | "/(app)/repositories/[id]" | "/(app)/runs" | "/(app)/runs/[id]" | "/(app)/settings/maintenance" | "/(app)/settings/notifications" | "/(public)/login" | "/(public)/setup" | null
