...
declare module "$app/types" {
	...
	export interface AppTypes {
		...
		Pathname(): "/" | "/api/v1/events" | "/api/v1/health" | "/api/v1/ready" | "/conflicts" | "/connections" | "/connections/new" | `/connections/${string}` & {} | "/health" | "/login" | "/logout" | "/pairs" | "/pairs/new" | `/pairs/${string}` & {} | "/ready" | "/repositories" | `/repositories/${string}` & {} | "/runs" | `/runs/${string}` & {} | "/setup";
